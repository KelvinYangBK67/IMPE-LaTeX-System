...
% automatic routing table compact while keeping representative routing
% regressions visible. Explicit local commands take precedence over these
% automatic owners in v1.0.0.
%
...
\hypersetup{
  ...
  pdfauthor = {IMPE LaTeX System v1.0.0},
...
set. This keeps the v1.0.0 showcase focused on routing correctness without
